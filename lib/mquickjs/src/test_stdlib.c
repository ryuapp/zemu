// This is the stdlib used for unit tests for the mquickjs Zig
// package. This won't be exposed via any of the public build API.
...
{
    return build_atoms("test_js_stdlib", js_global_object, js_c_function_decl, argc, argv);
}
